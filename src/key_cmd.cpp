...
TeleopCmd::TeleopCmd()
    : linear(0), angular(0), velocity(0.2), acceleration(0.5) {
  ...
  motor_steps_pub_ =
      nh->create_publisher<std_msgs::msg::Int32>("/motor_steps", 1);
  motor_accel_pub_ =
      nh->create_publisher<std_msgs::msg::Float32>("/motor_accel", 1);
}
